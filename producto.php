          ...
          <a href="#" class="btn btn-danger" onclick="eliminar('<?php echo $row['id_producto'];?>')" title="Eliminar"> <i class="glyphicon glyphicon-trash"></i> Eliminar </a>
              ...
              <div class="col-sm-4 text-left">
                <div class="row margin-btm-20">
                    ...
                    <div class="col-sm-8 margin-btm-10">
											<span><h3>Cantidad disponible: </h3></span>
                      <span class="item-quantity" style="color:red"><?php echo number_format($row['stock']);?></span>
                    </div>
										<div class="col-sm-12">
                      <span class="current-stock"> Precio de compra:  </span><span  class="current-stock" style="color:green">$<?php echo number_format($row['precio_pro_compra'],2);?></span>
                    </div>

										<div class="col-sm-12">
                      <span class="current-stock"> Precio de venta:  </span><span  class="current-stock" style="color:blue">$<?php echo number_format($row['precio_producto'],2);?></span>
                    </div>

                    <div class="col-sm-12 margin-btm-10">
										</div>
                    <div class="col-sm-6 col-xs-6 col-md-4 ">
                      <button type='button' class="btn btn-success"><a href="" data-toggle="modal" data-target="#add-stock"><h3>Añadir</h3><h1 class='glyphicon glyphicon-plus'></h1></a></button>
                    </div>
                    <div class="col-sm-6 col-xs-6 col-md-4">
                      <button type='button' class="btn btn-warning"><a href="" data-toggle="modal" data-target="#remove-stock"><h3>Quitar</h3><h1 class='glyphicon glyphicon-minus'></h1></a></button>
                    </div>
                    <div class="col-sm-12 margin-btm-10">
                    </div>
 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
	...
	$('#myModal2').on('show.bs.modal', function (event) {
		...
		modal.find('.modal-body #mod_precio_compra').val(precio_compra)
		modal.find('.modal-body #mod_precio').val(precio)
		modal.find('.modal-body #mod_iva').val(iva)
