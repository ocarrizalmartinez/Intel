...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <? echo "Intetel S.A. de C.V. "; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
		<tr>
		<td style="width:50%; "><strong>Dirección:</strong> <br>Colonia Centro, Tlaxiaco Oaxaca<br> Teléfono.: (044)953-120-0000</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        ...
        <tr>
            ...
            <td style="width:50%"><? echo $tel1; ?> </td>
        </tr>
        <tr>
            <td style="width:15%;"> Telefono:</td>
            <td style="width:50%"><? echo $tel2; ?> </td>
        </tr>
        <tr>
        ...
        <table cellspacing="0" style="width: 100%; text-align: left;font-size: 11pt">
        <tr>
             <td style="width:100%; ">A continuación se muestra su cotización.</td>
        </tr>
    </table>
    ...
    <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;padding:1mm;">
        <tr>
            ...
            <th style="width: 15%">PRECIO x UNIDAD</th>
...
<?php
$sumador_total=0;
$sql=mysqli_query($con, "select * from products, tmp_cotizacion where products.id_producto=tmp_cotizacion.id_producto and tmp_cotizacion.session_id='".$session_id."'");
