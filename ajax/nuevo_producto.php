...
include('is_logged.php');
	if (empty($_POST['codigo'])) {
		...
		$status_producto=intval($_POST['estado']);
		$precio_compra=floatval($_POST['precio_compra']);
		$precio_venta=floatval($_POST['precio']);
		$iva=intval($_POST['iva']);
		$date_added=date("Y-m-d H:i:s");

		$sql="INSERT INTO products (codigo_producto, nombre_producto, descripcion_producto, date_added, precio_producto, precio_pro_compra, iva, status_producto, stock, id_categoria)
		VALUES ('$codigo','$nombre','$descripcion_producto','$date_added','$precio_venta','$precio_compra','$status_producto','$iva','$stock','$id_categoria')";
