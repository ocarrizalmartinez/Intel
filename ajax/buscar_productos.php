            ...
            $descripcion_producto=$row['descripcion_producto'];
					...
					<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12 thumb text-center ng-scope" ng-repeat="item in records">
						  <a class="thumbnail" href="producto.php?id=<?php echo $id_producto;?>">
							  <span title="Cantidad disponible" class="badge badge-default stock-counter ng-binding"><?php echo number_format($stock); ?></span>
							  <span title="Low stock" class="low-stock-alert" ng-show="item.current_quantity <= item.low_stock_threshold"><i class="fa fa-exclamation-triangle"></i></span>
